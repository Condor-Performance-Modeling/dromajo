#MARCH="-march=rv32imacdf_zicond_zba_zbb_zbc_zbs_zfa_zfh -mabi=ilp32d  -mcmodel=medany"
MARCH="-march=rv64imacdf_zicond_zba_zbb_zbc_zbs_zfa_zfh -mabi=lp64d  -mcmodel=medany"
#MARCH="-march=rv64imacdfq_zicond_zba_zbb_zbc_zbs_zfa_zfh -mabi=lp128d -mcmodel=medany"

/data/tools/riscv-embecosm-embedded-ubuntu2204-20240407-14.0.1/bin/riscv64-unknown-elf-gcc -O3 -flto $MARCH -nostdlib -nostartfiles -ffast-math -funsafe-math-optimizations -finline-functions -fno-common -fno-builtin-printf -fno-tree-loop-distribute-patterns -DPREALLOCATE=1 -D__riscv=1  -static -std=gnu99 -I./inc -I../riscv-tests/env/p -I../riscv-tests/isa/macros/scalar  -T/data/users/jeffnye/condor/benchmarks/linker/common_proposed.ld \
