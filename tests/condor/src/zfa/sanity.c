...
#define BEGIN 1
#define END   0
void astar_region(int region);
//// -----------------------------------------------------------------
//// -----------------------------------------------------------------
//void print_loop_count(char i)
//{
//#ifdef __linux
//    printf("-I conio %d 0x%x\n",i,i);
//#endif
//}
//// -----------------------------------------------------------------
//// -----------------------------------------------------------------
//void print_loop_label(int begin,int region)
//{
//#ifdef __linux
//  if(begin==BEGIN) printf("-I begin delay loop, region %d\n",region);
//  else             printf("-I end delay loop,   region %d\n",region);
//#endif
//}
// -----------------------------------------------------------------
// -----------------------------------------------------------------
int main(int ac,char **av)
{
  ...
  (void)av;
  astar_region(7);
  for(int i = 0; i < 10; ++i) conio = (char) i;
  STOP_TRACE
  tohost = 1;
  return 0;
}
