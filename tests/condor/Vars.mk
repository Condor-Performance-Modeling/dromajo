...
ANDES_CC_OPTS =-mcpu=ax65 -mcmodel=medany -static -fvisibility=hidden -nostdlib -nostartfiles $(RVTST_INC) $(RVTST_LNK)
...
ANDES_SIM_OPTS=--ctrlc --trace 0 --march=rv64g_zba_zbb_zbc_zbs 
