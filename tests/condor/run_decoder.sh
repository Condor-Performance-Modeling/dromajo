...
/data/tools/riscv-embecosm-embedded-ubuntu2204-20240407-14.0.1/bin/riscv64-unknown-elf-objdump \
...
/data/users/jeffnye/condor/cpm.dromajo/bin/cpm_dromajo --ctrlc --trace 0 \
